<script lang="ts">
    ...
    let features = [
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/tracker.png',
            title: 'Tracker',
        ...
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/emergency.png',
            title: 'Emergency',
        ...
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/walkie-talkie.png',
            title: 'Walkie-Talkie',
            content: 'By simply pressing the button, it can transmit voice directly to the senior’s phone, even if it’s locked.'
        },
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/routines.png',
            title: 'Routines',
            content: 'Enhances the interactive display of senior’s schedules by adding medication and activity reminders in real-time. '
        },
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/ai-consultation.png',
    ...
    let connects = [
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/click.png',
        ...
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/enter.png',
        ...
        {
            image: 'https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/accept.png',
...
<nav class="flex items-center justify-between px-2 py-2 text-white md:py-4 md:px-8 lg:px-12 xl:px-24 bg-blue">
    <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/logo-type-white.png" alt="" class="h-8 md:h-12 ms-2 md:ms-0">
...
<div class="items-center hidden grid-cols-3 gap-1 pt-8 -mt-1 text-white md:pt-4 lg:pt-12 xl:gap-8 md:grid bg-blue">
    <div class="flex items-end justify-start mt-0 lg:mt-24">
        <div class="flex items-end h-72 lg:h-96">
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/caregiver.png" alt="" class="reveal-left">
        </div>
    </div>
    ...
    <div class="flex items-start justify-center h-full lg:mb-16">
        <div class="">
            ...
            <a href="https://apps.apple.com/id/app/careific-monitor-your-senior/id6471642474" target="_blank">
                <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/app-store.png" alt="" class="mx-auto transition w-36 lg:w-48 hover:scale-105">
            </a>
        </div>
    </div>
    ...
    <div class="flex items-end justify-end mt-0 lg:mt-24">
        <div class="flex items-end h-72 lg:h-96">
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/senior.png" alt="" class="reveal-right">
        </div>
    </div>
</div>
<div class="items-center justify-center hidden mb-8 -mt-64 lg:flex reveal-bottom">
    <div class="flex items-center justify-center gap-4 xl:gap-8">
        <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/tracker-jumbotron.png" alt="" class="h-128">
        <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/dashboard-jumbotron.png" alt="" class="h-128">
    </div>
</div>
...
<div class="px-2 text-white bg-blue md:hidden">
    <div class="flex items-start justify-center h-full mb-8">
        <div class="">
            ...
            <a href="https://apps.apple.com/id/app/careific-monitor-your-senior/id6471642474" target="_blank">
                <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/app-store.png" alt="" class="mx-auto w-36">
            </a>
        </div>
    </div>
    <div class="flex items-center justify-center">
        <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/family.png" alt="" class="reveal-right">
    </div>
</div>
...
<div class="grid items-center grid-cols-1 gap-4 px-4 py-8 lg:py-12 md:grid-cols-2 lg:gap-8 xl:gap-12 md:px-8 lg:px-12 xl:px-24" id="what-is-careific">
    <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/all-in-one.png" alt="" class="reveal-left">
...
<div class="px-4 py-8 lg:py-12 md:px-8 lg:px-12 xl:px-24" id="features">
    ...
    <div class="items-center hidden grid-cols-2 gap-2 md:grid xl:gap-8">
        {#if selectedFeature == "tracker"}
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/tracker.png" alt="" class="reveal-left">
        {:else if selectedFeature == "emergency"}
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/emergency.png" alt="" class="">
        {:else if selectedFeature == "walkie-talkie"}
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/walkie-talkie.png" alt="" class="">
        {:else if selectedFeature == "routines"}
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/routines.png" alt="" class="">
        {:else if selectedFeature == "ai-consultation"}
            <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/ai-consultation.png" alt="" class="">
        {/if}
...
<div class="pt-8 pb-12 lg:py-12 md:px-8 lg:px-12 xl:px-24 md:pb-0" id="connect">
    ...
    <div class="hidden grid-cols-3 gap-4 md:grid lg:gap-8 reveal-bottom">
        <div class="rounded-xl h-128">
            <div class="bg-blue h-1/3 lg:h-1/2 rounded-t-xl">
                <div class="flex items-center justify-center h-full p-4 pb-10">
                    <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/click.png" alt="" class="max-h-48">
                </div>
            </div>
        ...
        <div class="rounded-xl h-128">
            <div class="bg-blue h-1/3 lg:h-1/2 rounded-t-xl">
                <div class="flex items-center justify-center h-full p-4 pb-10">
                    <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/enter.png" alt="" class="max-h-48">
                </div>
            </div>
            <div class="border-b-2 border-x-2 h-1/2 border-gray rounded-b-xl">
                <div class="flex items-center justify-center">
        ...
        <div class="rounded-xl h-128">
            <div class="bg-blue h-1/3 lg:h-1/2 rounded-t-xl">
                <div class="flex items-center justify-center h-full p-4 pb-10">
                    <img src="https://juju222.sgp1.cdn.digitaloceanspaces.com/careific/accept.png" alt="" class="max-h-48">
                </div>
            </div>
            <div class="border-b-2 border-x-2 h-1/2 border-gray rounded-b-xl">
                <div class="flex items-center justify-center">
